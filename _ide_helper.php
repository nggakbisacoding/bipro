 ...
 */
     ...
     */ 
         ...
         *
         * @return \Modules\Auth\Entities\User|null 
         * @static 
         */ 
         ...
         *
         * @param mixed $id
         * @return \Modules\Auth\Entities\User|false 
         * @static 
         */ 
...
')
    ...
    namespace Kahasolusi\InstagramScraper\Facades { 
            /**
     * 
     *
     * @see \Kahasolusi\InstagramScraper\InstagramScraper
     */ 
        class InstagramScraper {
                    /**
         * Retrieves Instagram profile information and posts by username.
         *
         * @param string $username The username of the Instagram profile.
         * @param string $nextId (optional) The ID of the next post to retrieve.
         * @return array Returns an array containing the profile information and posts.
         * @throws \Exception Throws an exception if unable to retrieve the profile or if the profile is private.
         * @static 
         */ 
        public static function getByUsername($username, $nextId = '')
        {
                        /** @var \Kahasolusi\InstagramScraper\InstagramScraper $instance */
                        return $instance->getByUsername($username, $nextId);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \Kahasolusi\InstagramScraper\InstagramScraper $instance */
                        return $instance->getPostDetail($postId);
        }
    ...
    namespace Kahasolusi\TiktokScraper\Facades { 
            /**
     * 
     *
     * @see \Kahasolusi\TiktokScraper\TiktokScraper
     */ 
        class TiktokScraper {
                    /**
         * 
         ...
         * @static 
         */ 
        public static function getByUsername($username, $nextUrl = '')
        {
                        /** @var \Kahasolusi\TiktokScraper\TiktokScraper $instance */
                        return $instance->getByUsername($username, $nextUrl);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getByTag($tag, $nextUrl = '')
        {
                        /** @var \Kahasolusi\TiktokScraper\TiktokScraper $instance */
                        return $instance->getByTag($tag, $nextUrl);
        }
    ...
    namespace Kahasolusi\TwitterScraper { 
            /**
     * 
     *
     * @see \Kahasolusi\TwitterScraper\Skeleton\SkeletonClass
     */ 
        class TwitterScraperFacade {
                    /**
         * 
         *
         * @static 
         */ 
        public static function getPostDates($username, $since = null, $until = null, $type = 'account')
        {
                        /** @var \Kahasolusi\TwitterScraper\TwitterScraper $instance */
                        return $instance->getPostDates($username, $since, $until, $type);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getByUsernameV2($username, $next = '')
        {
                        /** @var \Kahasolusi\TwitterScraper\TwitterScraper $instance */
                        return $instance->getByUsernameV2($username, $next);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getBySearch($keyword, $next = '')
        {
                        /** @var \Kahasolusi\TwitterScraper\TwitterScraper $instance */
                        return $instance->getBySearch($keyword, $next);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \Kahasolusi\TwitterScraper\TwitterScraper $instance */
                        return $instance->getMediaUrl($url);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \Kahasolusi\TwitterScraper\TwitterScraper $instance */
                        return $instance->getProfile($username);
        }
...
namespace  { 
             ...
             * 
             *
             * @see \Deligoez\LaravelModelHashId\Mixins\FindByHashIdMixin::findByHashId()
             * @param mixed $id
             * @param mixed $columns
             * @static 
             */ 
            public static function findByHashId($id, $columns = [])
            {
                                return \Illuminate\Database\Eloquent\Builder::findByHashId($id, $columns);
            }
             
                /**
             * 
             *
             * @see \Deligoez\LaravelModelHashId\Mixins\FindManyByHashIdMixin::findManyByHashId()
             * @param \Illuminate\Contracts\Support\Arrayable|array $ids
             * @param mixed $columns
             * @static 
             */ 
            public static function findManyByHashId($ids, $columns = [])
            {
                                return \Illuminate\Database\Eloquent\Builder::findManyByHashId($ids, $columns);
            }
             
                /**
             * 
             *
             * @see \Deligoez\LaravelModelHashId\Mixins\FindOrFailByHashIdMixin::findOrFailByHashId()
             * @param mixed $id
             * @param mixed $columns
             * @static 
             */ 
            public static function findOrFailByHashId($id, $columns = [])
            {
                                return \Illuminate\Database\Eloquent\Builder::findOrFailByHashId($id, $columns);
            }
             
                /**
             * 
             *
             * @see \Deligoez\LaravelModelHashId\Mixins\FindOrByHashIdMixin::findOrByHashId()
             * @param mixed $id
             * @param mixed $columns
             * @param \Closure|null $callback
             * @static 
             */ 
            public static function findOrByHashId($id, $columns = [], $callback = null)
            {
                                return \Illuminate\Database\Eloquent\Builder::findOrByHashId($id, $columns, $callback);
            }
             
                /**
             * 
             *
             * @see \Deligoez\LaravelModelHashId\Mixins\FindOrNewByHashIdMixin::findOrNewByHashId()
             * @param mixed $id
             * @param mixed $columns
             * @static 
             */ 
            public static function findOrNewByHashId($id, $columns = [])
            {
                                return \Illuminate\Database\Eloquent\Builder::findOrNewByHashId($id, $columns);
            }
             
                /**
             * 
             *
             * @see \Deligoez\LaravelModelHashId\Mixins\WhereHashIdMixin::whereHashId()
             * @param mixed $id
             * @static 
             */ 
            public static function whereHashId($id)
            {
                                return \Illuminate\Database\Eloquent\Builder::whereHashId($id);
            }
             
                /**
             * 
             *
             * @see \Deligoez\LaravelModelHashId\Mixins\WhereHashIdNotMixin::whereHashIdNot()
             * @param mixed $id
             * @static 
             */ 
            ...
            class InstagramScraper extends \Kahasolusi\InstagramScraper\Facades\InstagramScraper {}
            class TiktokScraper extends \Kahasolusi\TiktokScraper\Facades\TiktokScraper {}
            class TwitterScraper extends \Kahasolusi\TwitterScraper\TwitterScraperFacade {}
