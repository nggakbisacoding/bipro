...
set('bin/php', function () {
    return '/opt/alt/php82/usr/bin/php';
});
set('application', 'Semantic');
set('repository', 'git@github.com:agungkes/laravel-semantic.git'); // Git Repository
...
host('staging')
    ...
    ->set('branch', 'main')
    ->set('deploy_path', '/home/kahasolu/semantic.kahasolusi.com');
