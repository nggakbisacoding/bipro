...
namespace Modules\Auth\Entities\Traits\Method;
...
trait UserMethod
{
    ...
    {
        return 'https://gravatar.com/avatar/'.hash('sha256', strtolower(trim($this->email))).'?s='.config('boilerplate.avatar.size', $size).'&d=mp';
    }
}
