...
use Modules\Auth\Events\Role\RoleCreated;
use Modules\Auth\Events\Role\RoleDeleted;
use Modules\Auth\Events\Role\RoleUpdated;
...
class RoleEventListener
{
    ...
    public function subscribe($events)
    {
        $events->listen(
            RoleCreated::class,
            'Modules\Auth\Listeners\RoleEventListener@onCreated'
        );

        $events->listen(
            RoleUpdated::class,
            'Modules\Auth\Listeners\RoleEventListener@onUpdated'
        );

        $events->listen(
            RoleDeleted::class,
            'Modules\Auth\Listeners\RoleEventListener@onDeleted'
        );
    }
}
